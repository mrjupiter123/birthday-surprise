...
export const birthdayConfig = {
  ...
  memories: [
    ...
    {date:"A Little Adventure", title:"The Best Kind of Days", description:"The ordinary moments somehow become extraordinary with you.", image:"/birthday-surprise/memories/2.jpg", caption:"One for the books"},
    {date:"One of My Favorites", title:"That Smile", description:"A reminder to always make more room for joy.", image:"/birthday-surprise/memories/3.jpg", caption:"Pure sunshine"}
  ] satisfies Memory[],
  gallery: [
    {image:"/birthday-surprise/memories/1.jpg",caption:"A precious little moment"},{image:"/birthday-surprise/memories/2.jpg",caption:"Just us"},{image:"/birthday-surprise/memories/3.jpg",caption:"Sunshine energy"},{image:"/birthday-surprise/memories/4.jpg",caption:"A day to remember"},{image:"/birthday-surprise/memories/5.jpg",caption:"Beautiful memories"},{image:"/birthday-surprise/memories/6.jpg",caption:"More adventures ahead"}
  ]
} as const;
